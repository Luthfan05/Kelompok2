...
private void autoid1(){
    ...
    private void initComponents() {
        ...
        penghuni1 = new javax.swing.JComboBox<>();
        lantai1 = new javax.swing.JComboBox<>();
        ...
        penghuni1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-SELECT-" }));
        penghuni1.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                penghuni1ItemStateChanged(evt);
            }
        });

        lantai1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-SELECT-" }));

        prtmn.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2022-12-05 - 2022-12-11", "2021-10-10 - 2021-10-16", "2021-10-17 - 2021-10-23", "2021-10-24 - 2021-10-30", "2021-10-31 - 2021-11-06", "2021-11-07 - 2021-11-13", "2021-11-14 - 2021-11-20", "2021-11-21 - 2021-11-27", "2021-11-28 - 2021-12-04" }));
                ...
                .addGroup(card3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(card3Layout.createSequentialGroup()
                        .addGroup(card3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(penghuni1, 0, 130, Short.MAX_VALUE))
                        .addGap(104, 104, 104)
                        .addGroup(card3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jLabel7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jButton3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(lantai1, 0, 130, Short.MAX_VALUE)
        ...
        card3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, card3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(card3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(penghuni1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lantai1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        lantai2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-SELECT-" }));

        prtmn1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2022-12-05 - 2022-12-31", " " }));
    ...
    private void show_combo3(){
        try {
            ...
            while (rs.next()){
                penghuni1.addItem(rs.getString("nama"));
    ...
    private void show_combo4(){
        try {
            ...
            while (rs.next()){
               ...
               lantai1.addItem(rs.getString("lantai"));
    ...
    public void show_data(){
        ...
        try {
            java.sql.Connection con = (java.sql.Connection)Home.Koneksi.getKoneksi();
            String sql = "SELECT penghuni.kode_kamar, penghuni.nama, lantai.lantai, absen.keterangan FROM absen LEFT JOIN penghuni ON absen.kode_kamar = penghuni.kode_kamar LEFT JOIN lantai ON absen.id_lantai = lantai.id_lantai";
    ...
    public void show_data4(){
        ...
        try {
            java.sql.Connection con = (java.sql.Connection)Home.Koneksi.getKoneksi();
            String sql = "SELECT penghuni.kode_kamar, penghuni.nama, lantai.lantai, absen_malam.keterangan FROM absen_malam LEFT JOIN penghuni ON absen_malam.kode_kamar = penghuni.kode_kamar LEFT JOIN lantai ON absen_malam.id_lantai = lantai.id_lantai";
            java.sql.PreparedStatement stm = con.prepareStatement(sql);
            ResultSet rs =stm.executeQuery(sql);
            while (rs.next()) {
                tabel.addRow(new Object[]{
    ...
    public void scndtable(){
        ...
        try {
            java.sql.Connection con = (java.sql.Connection)Home.Koneksi.getKoneksi();
            String sql = "SELECT penghuni.kode_kamar, penghuni.nama, SUM(absen.keterangan = 'Hadir' AND absen.id_lantai = '"+chooseid1(lantai1)+"', SUM(absen.keterangan = 'Izin' AND absen.id_lantai = '"+chooseid1(lantai1)+"', SUM(absen.keterangan = 'Tanpa Keterangan' AND absen.id_lantai = '"+chooseid1(lantai1)+"' FROM penghuni JOIN absen ON penghuni.kode_kamar = absen.kode_kamar JOIN lantai ON absen.id_lantai = lantai.id_lantai GROUP BY penghuni.kode_kamar;";
    ...
    public void scndtable1(){
        ...
        try {
            java.sql.Connection con = (java.sql.Connection)Home.Koneksi.getKoneksi();
            String sql = "SELECT penghuni.kode_kamar, penghuni.nama, SUM(absen.keterangan = 'Hadir' AND absen.id_lanntai = '"+chooseid1(lantai2)+"', SUM(absen.keterangan = 'Izin' AND absen.id_lantai = '"+chooseid1(lantai2)+"'), SUM(absen.keterangan = 'Tanpa Keterangan' AND absen.id_lantai = '"+chooseid1(lantai2)+"') FROM penghuni JOIN absen ON penghuni.kode_kamar = absen.kode_kamar JOIN ON absen.id_lantai =.id_lantai GROUP BY penghuni.kode_kamar;";
            System.out.println(sql);
            java.sql.PreparedStatement stm = con.prepareStatement(sql);
            ResultSet rs =stm.executeQuery(sql);
            while (rs.next()) {
    ...
    public void show_data1(){
        if (penghuni1.getSelectedItem() == "-SELECT-" && lantai1.getSelectedItem() == "-SELECT-"){
            String sql = "";
            DefaultTableModel tabel = new DefaultTableModel();
            tabel.addColumn("Keterangan");
            ...
            try {
                java.sql.Connection con = (java.sql.Connection)Home.Koneksi.getKoneksi();
                sql = "SELECT absen.keterangan, COUNT(*) FROM penghuni JOIN absen ON penghuni.kode_kamar = absen.kode_kamar JOIN lantai ON absen.id_lantai = lantai.id_lantai GROUP BY absen.keterangan;";
                System.out.println(sql);
                java.sql.PreparedStatement stm = con.prepareStatement(sql);
                ResultSet rs =stm.executeQuery(sql);
                while (rs.next()) {
        ...
        } else if (penghuni1.getSelectedItem() == "-SELECT-" && lantai1.getSelectedItem() != "-SELECT-") {
            String sql = "";
            DefaultTableModel tabel = new DefaultTableModel();
            tabel.addColumn("Keterangan");
            tabel.addColumn("Jumlah Total");
            try {
                java.sql.Connection con = (java.sql.Connection)Home.Koneksi.getKoneksi();
                sql = "SELECT absen.keterangan, COUNT(*) FROM penghuni JOIN absen ON penghuni.kode_kamar = absen.kode_kamar JOIN lantai ON absen.id_lantai = lantai.id_lantai WHERE lantai.id_lantai = '"+chooseid1(lantai1)+"' GROUP BY absen.keterangan;";
                System.out.println(sql);
                java.sql.PreparedStatement stm = con.prepareStatement(sql);
                ResultSet rs =stm.executeQuery(sql);
                while (rs.next()) {
            ...
            try {
                java.sql.Connection con = (java.sql.Connection)Home.Koneksi.getKoneksi();
                String sql = "SELECT penghuni.kode_kamar, penghuni.nama, SUM(absen.keterangan = 'Hadir' AND absen.kode_kamar = '"+chooseid(penghuni1)+"', SUM(absen.keterangan = 'Izin' AND absen.kode_kamar = '"+chooseid(penghuni1)+"', SUM(absen.keterangan = 'Tanpa Keterangan' AND absen.kode_kamar = '"+chooseid(penghuni1)+"' FROM penghuni JOIN absen ON penghuni.kode_kamar = absen.kode_kamar JOIN lantai ON absen.id_lantai = lantai.id_lantai WHERE absen.kode_kamar = '"+chooseid(penghuni1)+"' GROUP BY penghuni.kode_kamar;";
                System.out.println(sql);
                java.sql.PreparedStatement stm = con.prepareStatement(sql);
                ResultSet rs =stm.executeQuery(sql);
                while (rs.next()) {
    ...
    public void show_data2(){
        if (penghuni2.getSelectedItem() == "-SELECT-" && lantai2.getSelectedItem() == "-SELECT-"){
            ...
            try {
                java.sql.Connection con = (java.sql.Connection)Home.Koneksi.getKoneksi();
                sql = "SELECT absen.keterangan, COUNT(*) FROM penghuni JOIN absen ON penghuni.kode_kamar = absen.kode_kamar GROUP BY absen.keterangan;";
                System.out.println(sql);
                java.sql.PreparedStatement stm = con.prepareStatement(sql);
                ResultSet rs =stm.executeQuery(sql);
                while (rs.next()) {
            ...
            try {
                java.sql.Connection con = (java.sql.Connection)Home.Koneksi.getKoneksi();
                String sql = "SELECT penghuni.kode_kamar, penghuni.nama, SUM(absen.keterangan = 'Hadir' AND absen.kode_kamar = '"+chooseid(penghuni2)+"', SUM(absen.keterangan = 'Izin' AND absen.kode_kamar = '"+chooseid(penghuni2)+"', SUM(absen.keterangan = 'Tanpa Keterangan' AND absen.kode_kamar = '"+chooseid(penghuni2)+"'FROM penghuni JOIN absen ON penghuni.kode_kamar = absen.kode_kamar JOIN lantai ON absen.id_lantai = lantai.id_lantai WHERE absen.kode_kamar = '"+chooseid(penghuni2)+"' GROUP BY penghuni.kode_kamar;";
                System.out.println(sql);
                java.sql.PreparedStatement stm = con.prepareStatement(sql);
                ResultSet rs =stm.executeQuery(sql);
                while (rs.next()) {
    ...
    private void penghuni1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_penghuni1ItemStateChanged
        show_data1();
    }//GEN-LAST:event_penghuni1ItemStateChanged
    ...
    private javax.swing.JComboBox<String> lantai1;
    ...
    private javax.swing.JComboBox<String> penghuni1;
